<?php
//echo "<pre>";
$_SESSION['bookingData'] = $_REQUEST;
//print_r($_SESSION['bookingData']);
//echo "</pre>";
?>
<div class="category">
    <h3>Booking Confirmation</h3>
    <form action="<?php echo site_url('rent/submitBooking'); ?>" method="post" id="form_invoice" class="form-horizontal">
        <div class="content-subject">
            ...
            <div class="control-group">
                ...
                <div class="controls autocomplete-jui">
                        <input type="hidden" id="cname" name="cname"  /><?php echo $_REQUEST['cname']; ?><br>
                </div>
            </div>
            <div class="control-group">
    ...
    .product_attr{
        display:none;
            ...
            <table class="table table-striped table-bordered" id="add_product_table">
               ...
               {
                    foreach($_REQUEST['product_id'] as $item=>$val)
                    { ?>
                        <tr>
                            <td><?php echo $item;?><?php echo $_REQUEST['product_id'][$item];?></td>
                            <td><?php echo $_REQUEST['product_name'][$item]; ?></td>
                            <td><?php echo $_REQUEST['product_quantity'][$item];?></td>
                            <td><?php echo $_REQUEST['product_price'][$item];?></td>
                            <td><?php echo $_REQUEST['components'][$item];?></td>
                        </tr>
                   <?php }
                ...
                ?>
                        <tr>
                            <td><?php echo $item;?><?php echo $_REQUEST['pcomponent_cid'][$item];?></td>
    ...
    <div style="float:right;border:0px solid #ccc;margin:10px;"> 
        ...
        <div class="bill-field"><input type="text" value="<?php echo $_REQUEST['total_rent'];?>" name="total_rent" id="total_rent" readonly/> </div><br/>
        <div class="bill-label">Deposit :</div>
        <div class="bill-field"><input type="text"value="<?php echo $_REQUEST['deposit'];?>" name="deposit" id="advance_amount" onBlur="rent_products.updateBalance();"/> </div>
        <div class="bill-label">Balance :</div>
        <div class="bill-field"><input type="text"value="<?php echo $_REQUEST['balance'];?>" name="balance" id="balance_amount"/> </div>
