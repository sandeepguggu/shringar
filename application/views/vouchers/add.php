<div class="new-gift-voucher">
    <div class="content-header">
        <h3>New Gift Voucher</h3>
    </div>
    <form class="form-horizontal" action="<?php echo site_url('vouchers/add_to_db?ajax=1'); ?>" method="post" id="form_add_voucher" onsubmit="return false;">
        <div class="content-subject">
            ...
            <div class="control-group amount-type-amount">
                ...
                <div class="controls">
                    <input type="text" name="amount_value" class="required number" min="0">
                </div>
            </div>
            <div class="control-group amount-type-amount">
...
<script type="text/javascript">
    BIZ.app.bind({
        event: 'change',
        parentElement: '.new-gift-voucher',
