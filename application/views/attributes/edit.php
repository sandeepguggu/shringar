    ...
    <form class="form-horizontal" action="<?php echo site_url('attribute/add_to_db?ajax=1'); ?>" method="post" id="form_add_attribute" onsubmit="return false;">
        <div class="content-subject">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="display_name" class="required" value="<?php echo isset($display_name) ? $display_name : ''; ?>"/>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">Level:</label>
                <div class="controls">
                    <label><?php echo (isset($level) && $level == 1) ? 'Primary' : 'Secondary'; ?></label>
                </div>
            </div>
            <div class="control-group">
