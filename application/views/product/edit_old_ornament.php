...
<?php else: ?>
<span class="span16"><strong>Edit Old Ornament</strong> </span>
<br />
<br />
form action="<?=site_url('product/edit_old_ornament_to_db?ajax=1');?>" id="edit-old_ornament-form"
		...
		<tbody>
			...
			<tr>
				...
				<td><input type="text" class="required number" min="0" name="weight" />
					<select>
						<option value="gm" selected="selected">g</option>
